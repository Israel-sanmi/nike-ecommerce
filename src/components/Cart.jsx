      ...
      >
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            <div>
              <div className="flex items-start justify-start flex-col gap-y-7 overflow-y-scroll h-[81vh] scroll-smooth scroll-hidden py-3 lg:gap-y-5">
                {cartItems?.map((item, i) => {
                  return <CartItem key={i} item={item} />;
                })}
              </div>
              <div className="fixed bottom-0 bg-white py-2 grid items-center w-full px-5 ">
