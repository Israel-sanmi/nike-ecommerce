...
const Item = ({
  ...
  return (
    <div className="w-full">
      <div
        className={`relative cursor-pointer bg-gradient-to-b ${color} ${shadow} grid items-center  ${
        ...
        >
          ...
          <div className=" flex items-center gap-3">
            <button
              ...
              onClick={() => onAddToCart()}
            >
              <BsFillBagFill className="icons-style text-slate-900" />
            </button>
            <button
              type="button"
              onClick={() => {
              ...
              className="bg-white opacity-90 blur-effect-theme button-theme px-2 py-1 shadow text-sm text-black shadow-slate-200"
            >
              {btn}
            </button>
          </div>
